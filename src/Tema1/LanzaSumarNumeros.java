...
public class LanzaSumarNumeros {
    public static void main(String[] args) throws IOException {
        ...
        // Ejecutar la clase SumarNumeros
        ProcessBuilder pb = new ProcessBuilder("java", "-cp", directorio.getAbsolutePath(), "Tema1.SumarNumeros");
